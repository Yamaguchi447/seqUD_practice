...
class UniformDesignSampler(BaseSampler):
    def __init__(
        ...
        # Generate uniform design in [0, 1] space
        ...
        # Scale the design space to match the parameter ranges
        ...
        for i, param_name in enumerate(self._param_names):
            ...
            lower_bound, upper_bound = distribution.low, distribution.high
            ...
            self._ud_space[:, i] = ud_space[self._base_ud[:, i] - 1, i] * scale + shift
